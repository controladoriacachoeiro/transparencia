          ...
          <div class="box box-primary">
            ...
            <div class="box-body text-justify">  
              <ul class="links-gestao">
                <li>
                  <a class="acessibilidade" target="_blank" href="{{route('downloadGestaoFiscal', ['tipoArquivo' => 'ldo', 'nomeArquivo' => 'LDO 2020 - Lei 7788 - Diario 5973.pdf'])}}">LDO 2020 - Lei 7788 - Diario 5973</a>
                </li>
                <li>
