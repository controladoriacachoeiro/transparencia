                    ...
                    foreach ($colunaDados as $valorColuna) {
                        switch ($valorColuna) {
                            case 'Órgão':
                                ...
                                echo "<td scope='col'><a href='". route('MostrarPagamentoFuncaoOrgao', ['datainicio' => $datainicio, 'datafim' => $datafim,'funcao' =>$funcao ,'orgao' => $orgao]) ."'>". $valor->Orgao ."</a></td>";
                                break;
                            ...
                            case 'Funções':
                                $funcao = App\Auxiliar::ajusteUrl($valor->Funcao);
                                echo "<td scope='col'><a href='". route('MostrarPagamentoFuncao', ['datainicio' => $datainicio, 'datafim' => $datafim, 'orgao' => $valor->Orgao,'funcao' =>$funcao]) ."'>". $valor->Funcao ."</a></td>";
                                break;
                            case 'Fornecedores':
                                $orgao = App\Auxiliar::ajusteUrl($valor->Orgao);
                                $funcao = App\Auxiliar::ajusteUrl($valor->Funcao);
                            ...
                            case 'Nota de Pagamento':
                                ...
                                <td scope='col'>
                                    {{Form::open(array('action' => array('Despesas\PagamentosController@mostrarPagamentoPelaNota', 'funcoes')))}}
