                    ...
                    foreach ($colunaDados as $valorColuna) {
                        switch ($valorColuna) {
                            ...
                            case 'Fornecedor':
                                ...
                                echo "<td><a href='". route('MostrarEmpenhoOrgaoFornecedor', ['datainicio' => $datainicio, 'datafim' => $datafim, 'orgao' => $valor->UnidadeGestora,'fornecedor' =>$fornecedor]) ."'>". $valor->Beneficiario ."</a></td>";
                                break;  
