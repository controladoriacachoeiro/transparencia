            ...
            <tbody>
                ...
                foreach ($dadosDb as $valor) {                    
                    ...
                    foreach ($colunaDados as $valorColuna) {
                        switch ($valorColuna) {
                            case 'Órgão':
                                echo "<td scope='col'><a href='". route('MostrarPagamentoRestoElementoOrgao', ['datainicio' => $datainicio, 'datafim' => $datafim,'elemento' =>$valor->ElemDespesa ,'orgao' => $valor->Orgao]) ."'>". $valor->Orgao ."</a></td>";
                                break;
                            ...
                            case 'Nota de Pagamento':
                                ...
                                <td scope='col'>
                                    {{Form::open(array('action' => array('Despesas\PagamentoRestoController@mostrarPagamentoRestoPelaNota', 'elementos')))}}
...
var instance = new TableExport(ExportButtons, {
    formats: ['xls','csv'],
    exportButtons: false,
    filename:'resto elemento despesa'
});
