            ...
            <tbody>
                ...
                foreach ($dadosDb as $valor) {                    
                    ...
                    foreach ($colunaDados as $valorColuna) {
                        switch ($valorColuna) {
                            case 'Órgão':
                                echo "<td scope='col'><a href='". route('MostrarPagamentoRestoOrgao', ['datainicio' => $datainicio, 'datafim' => $datafim, 'orgao' => $valor->Orgao]) ."'>". $valor->Orgao ."</a></td>";
                                break;
                            ...
                            case 'Fornecedores':
                                ...
                                echo "<td scope='col'><a href='". route('MostrarPagamentoRestoOrgaoFornecedor', ['datainicio' => $datainicio, 'datafim' => $datafim, 'orgao' => $valor->Orgao,'fornecedor' =>$fornecedor]) ."'>". $valor->Beneficiario ."</a></td>";
                                break;  
                            ...
                            case 'Nota de Pagamento':
                                ...
                                <td scope='col'>
                                    {{Form::open(array('action' => array('Despesas\PagamentoRestoController@mostrarPagamentoRestoPelaNota', 'orgaos')))}}
