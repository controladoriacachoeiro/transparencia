...
@section('elementosDoFiltro')
    <span class="quadroFiltro">Órgão</span>: {{$orgao}} </br>
                ...
                foreach ($dadosDb as $valor) {                    
                    ...
                    foreach ($colunaDados as $valorColuna) {                        
                        switch ($valorColuna) {
                            ...
                            case 'Órgão Lotação':
                                if ($nivel == 1){
                                    echo "<td><a href='". route('MostrarServidoresOrgao', ['orgao' => $valor->OrgaoLotacao, 'situacao' => $situacao]) ."'>". $valor->OrgaoLotacao ."</a></td>";
                                }else{                                                                                                
