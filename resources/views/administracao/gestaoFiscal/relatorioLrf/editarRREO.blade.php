@extends('layouts.app')
@section('htmlheader_title', 'Editar Arquivo RREO')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading acessibilidade">Editar Arquivo RREO</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="idForm" action="/editarArquivoRREO" enctype="multipart/form-data" data-toggle="validator" role="form">
                        @csrf
...
@section('scriptsadd')
    ...
    <script>
        ...
        $("#ano").val($('option:contains({{$dadosDb[0]->ano}})').val());
        $("#bimestre").val($('option:contains({{$dadosDb[0]->periodo_ug}})').val());
    </script>
