@extends('layouts.app')
@section('htmlheader_title', 'Editar Arquivo Balanço Anual')
...
@section('scriptsadd')
    ...
    <script>
        ...
        if(dados[0].periodo_ug == null){
            $("#periodo_ug").val($('option:contains(Nenhuma)').val());
        } else{
            $("#periodo_ug").val($('option:contains({{$dadosDb[0]->periodo_ug}})').val());
        }
    </script>
